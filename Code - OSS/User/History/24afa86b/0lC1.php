      ...
      <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <form action="" method="post" enctype="multipart/form-data" name="uploadform">
            ...
            <input type="submit" value="Upload" class="cursor-pointer rounded-lg border border-indigo-800 bg-indigo-800 p-4 font-medium text-white transition hover:bg-opacity-90" name="submit" />
          </form>
          <!-- ====== Table Section Start -->
