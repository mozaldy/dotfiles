...
<input class="block w-50 text-lg text-indigo-800 border border-gray-300 rounded-lg flex-grow cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="userfile" type="file" name="userfile">
            ...
            <input type="submit" value="Upload" class="cursor-pointer rounded-lg border border-indigo-800 bg-indigo-800 font-medium text-white transition hover:bg-opacity-90" name="submit" />
          </form>
          <!-- ====== Table Section Start -->
